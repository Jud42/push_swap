...
SRCS	= main.c	parse_input.c	init_struct.c	utiList.c	print_list.c	fonction42.c	sort_stack_a.c	sort_stack_b.c five_manage.c	three_manage_a.c	three_manage_b.c	two_manage.c	push_swap.c	sort_base.c	
DIR_S	= srcs
DIR_O	= temp
RM 	= rm -rf
